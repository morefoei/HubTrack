            ...
            <div class="card">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 0.5rem; margin-bottom: 1rem; flex-wrap: wrap; gap: 1rem;">
                    <div style="display: flex; align-items: center; gap: 0.5rem; color: var(--text-muted); font-size: 0.9rem;">
                        ...
                        baris
                        <select id="filterLogMonth" style="margin-left: 1rem; padding: 0.4rem 2.5rem 0.4rem 0.8rem; border-radius: 6px; border: 1px solid var(--panel-border); background: #1e293b; color: var(--text-main); cursor: pointer; min-width: 150px; width: auto; font-size: 0.9rem; appearance: auto;">
